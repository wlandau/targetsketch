...
Anyone can submit an issue to <https://github.com/wlandau/targetsketch/issues> or comment on an existing thread. Common reasons are to
...
* For bug reports: if you can, please install the latest GitHub version of `targetsketch` (i.e. `remotes::install_github("wlandau/targetsketch")`) and verify that the issue still persists.
...
1. Prior to contribution, please propose your idea in a [new issue thread](https://github.com/wlandau/targetsketch/issues) so you and the maintainer can define the intent and scope of your work.
